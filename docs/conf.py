# -*- coding: utf-8 -*-
#
# Основы Веб-программирования documentation build configuration file, created by
...
latex_documents = [
  ('index', '-.tex', u'Основы Веб-программирования Documentation',
   u'uralbash', 'manual'),
]
...
#epub_basename = u'Основы Веб-программирования'
