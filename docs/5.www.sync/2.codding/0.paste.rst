...
.. note:: | Исходный код данного примера доступен по адресу:
   ...
   * https://github.com/ustu/lectures.www/tree/master/sourcecode/wsgi/blog/0.paster
...
.. literalinclude:: /../sourcecode/wsgi/blog/0.paster/5_step.py
   :language: python
   :pyobject: BlogCreate
   :linenos:
...
.. literalinclude:: /../sourcecode/wsgi/blog/0.paster/middlewares/basicauth.py
   :language: python
   :pyobject: BasicAuth
   :linenos:
...
.. literalinclude:: /../sourcecode/wsgi/blog/0.paster/6_step.py
   :language: python
