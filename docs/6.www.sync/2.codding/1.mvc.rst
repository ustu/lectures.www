...
.. note:: | Исходный код доступен по адресу:
   ...
   * https://github.com/ustu/lectures.www/tree/master/sourcecode/5.www.sync/2.codding/blog/1.mvc/
...
.. literalinclude:: /../sourcecode/5.www.sync/2.codding/blog/1.mvc/models.py
   :language: python
   :linenos:
...
.. literalinclude:: /../sourcecode/5.www.sync/2.codding/blog/1.mvc/__init__.py
   :language: python
...
.. literalinclude:: /../sourcecode/5.www.sync/2.codding/blog/1.mvc/views.py
   :language: python
   :emphasize-lines: 5
