...
В результате получим новое отображение блога, но пока мы не укажем ему откуда брать статику, он ее не сможет найти.
...
.. figure:: /_static/6.www.sync/4.static/blog_scheme.png
   :align: center
