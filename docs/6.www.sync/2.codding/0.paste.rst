...
.. note:: | Исходный код данного примера доступен по адресу:
   ...
   * https://github.com/ustu/lectures.www/tree/master/sourcecode/6.www.sync/2.codding/blog/0.paster
...
.. literalinclude:: /../sourcecode/6.www.sync/2.codding/blog/0.paster/0_step.py
   :language: python
   :linenos:
...
.. literalinclude:: /../sourcecode/6.www.sync/2.codding/blog/0.paster/middlewares/urldispatch.py
   :language: python
...
.. literalinclude:: /../sourcecode/6.www.sync/2.codding/blog/0.paster/1_step.py
   :language: python
...
.. literalinclude:: /../sourcecode/6.www.sync/2.codding/blog/0.paster/2_step.py
   :language: python
...
.. literalinclude:: /../sourcecode/6.www.sync/2.codding/blog/0.paster/3_step.py
   :language: python
...
.. literalinclude:: /../sourcecode/6.www.sync/2.codding/blog/0.paster/4_step.py
   :language: python
   :pyobject: BlogIndex
   :emphasize-lines: 6-9
   :linenos:
...
.. literalinclude:: /../sourcecode/6.www.sync/2.codding/blog/0.paster/5_step.py
   :language: python
   :pyobject: BlogCreate
   :linenos:
...
.. literalinclude:: /../sourcecode/6.www.sync/2.codding/blog/0.paster/middlewares/basicauth.py
   :language: python
   :pyobject: BasicAuth
   :linenos:
...
.. literalinclude:: /../sourcecode/6.www.sync/2.codding/blog/0.paster/6_step.py
   :language: python
