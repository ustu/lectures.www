...
.. glossary::
   ...
   view callable
     ...
     :l:`Pyramid`.  See :ref:`views_chapter` for more information
     about :l:`Pyramid` view callables.
   ...
   view configuration
     ...
     influence the response of a view callable.  :l:`Pyramid` views can be
   ...
   traversal
     ...
     :l:`Pyramid` :term:`router` performs traversal of resource objects
   ...
   authentication
     ...
     :l:`Pyramid` is performed via an :term:`authentication
     policy`.
   ...
   authorization
     ...
     Authorization in :l:`Pyramid` is performed via its
   ...
   userid
     ...
     of the authentication policies :l:`Pyramid` provides is to
   ...
   authorization policy
     An authorization policy in :l:`Pyramid` terms is a bit of
   ...
   authentication policy
     An authentication policy in :l:`Pyramid` terms is a bit of
   ...
   WSGI
     ...
     similar to the concept of Java Servlets.  :l:`Pyramid` requires
   ...
   PasteDeploy
     ...
     :l:`Pyramid` which makes it possible to configure
   ...
   Chameleon
     ...
     implementation of ZPT.  :l:`Pyramid` offers Chameleon templating out
   ...
   Routes
     ...
     mappings. The URL pattern matching syntax in :l:`Pyramid` is
   ...
   Zope Component Architecture
     ...
     :l:`Pyramid` uses the ZCA "under the hood" to perform view
   ...
   root
     The object at which :term:`traversal` begins when :l:`Pyramid`
   ...
   interface
     ...
     :term:`event` system. Fundamentally, :l:`Pyramid`
   ...
   request type
     ...
     :term:`request` object that :l:`Pyramid` generates and
   ...
   repoze.lemonade
     ...
     applications useful within :l:`Pyramid` applications.
   ...
   root factory
     The "root factory" of a :l:`Pyramid` application is called on every
     ...
     application may supply a root factory to :l:`Pyramid` during the
   ...
   mod_wsgi
     ...
     :l:`Pyramid`) to be served using the Apache web server.
   ...
   predicate
     ...
     of predicates exist in :l:`Pyramid`: a :term:`view predicate`
   ...
   decorator
     ...
     arbitrary object.  :l:`Pyramid` provides several decorators,
   ...
   scan
     The term used by :l:`Pyramid` to define the process of
   ...
   Not Found View
      An :term:`exception view` invoked by :l:`Pyramid` when the developer
      ...
      configuration`.  :l:`Pyramid` provides a default implementation of a
   ...
   Forbidden view
      ...
      :l:`Pyramid` provides a default implementation of a forbidden view;
      it can be overridden.  See :ref:`changing_the_forbidden_view`.

   Exception view
      An exception view is a :term:`view callable` which may be
      invoked by :l:`Pyramid` when an exception is raised during
   ...
   thread local
      ...
      :l:`Pyramid` uses a small number of thread local variables, as
   ...
   Venusian
     ...
     deferred until a separate "scan" phase.  :l:`Pyramid` relies
   ...
   Translator
     ...
     :term:`localizer` supplies a translator to a :l:`Pyramid` application
   ...
   Gettext
     ...
     library, used by the :l:`Pyramid` translation machinery.

   Babel
     A `collection of tools <http://babel.edgewall.org/>`_ for
     internationalizing Python applications.  :l:`Pyramid` does
   ...
   pyramid_zcml
     An add-on package to :l:`Pyramid` which allows applications to be
   ...
   pyramid_handlers
     An add-on package which allows :l:`Pyramid` users to create classes
   ...
   tween
     ...
     :l:`Pyramid` as its 'app'.  The word "tween" is a contraction of
